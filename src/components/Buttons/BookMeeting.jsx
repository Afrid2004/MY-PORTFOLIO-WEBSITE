...
export default function BookMeeting() {
  ...
  return (
    <button
      className="px-8 py-4 bg-primary text-secondary rounded-4xl font-medium hover:bg-transparent hover:text-primary hover:border-primary border-2 border-primary duration-150 cursor-pointer flex items-center gap-2 leading-none"
