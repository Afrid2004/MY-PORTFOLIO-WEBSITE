        ...
        <div className="overflow-hidden rounded-3xl border border-white/5 bg-white/[0.02]">
          <div className="border-b border-white/10 bg-primary/5 px-6 py-6">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              ...
              <div className="h-7 w-36 rounded-full bg-base-content/10" />
            </div>
          </div>
          ...
          <div className="p-6">
            ...
            <div>
              ...
              <div className="mt-5 flex flex-wrap gap-2">
                {[...Array(6)].map((_, item) => (
                  <div
                    key={item}
                    className="h-8 w-28 rounded-full bg-base-content/10"
                  />
                ))}
              </div>
            </div>
            ...
            <div>
              <div className="h-5 w-20 rounded bg-base-content/10" />
              <div className="mt-4 h-8 w-24 rounded-full bg-base-content/10" />
            </div>
          </div>
        </div>
      </div>
