      ...
      <div>
        <div className="bg-base-200/70 relative overflow-hidden">
          <div className="container py-16">
            ...
            >
              ...
              >
                <h2 className="text-4xl md:text-6xl lg:text-7xl xl:text-8xl font-bold">
                  ...
                  <span className="text-primary inline-block">Amazing</span>
                </h2>
              </Reveal>
              ...
              <Reveal
                initial="opacity-0 translate-y-7"
                view="opacity-100 translate-y-0"
                transition="transition-all duration-700 ease-[cubic-bezier(0.22,1,0.36,1)] delay-[350ms]"
                viewport={0.5}
              >
            ...
            <div className="grid gap-10 md:grid-cols-3">
              ...
              <Reveal
                initial="opacity-0 translate-y-7"
                view="opacity-100 translate-y-0"
                transition="transition-all duration-700 ease-[cubic-bezier(0.22,1,0.36,1)] delay-[150ms]"
                viewport={0.3}
              >
                <div>
            ...
            >
              <div className="pt-6 flex flex-col md:flex-row items-center justify-between gap-5">
                <p className="text-sm">
                  © {new Date().getFullYear()} Faisal Afrid. All rights
                  reserved.
                </p>
          ...
          <div className="absolute -bottom-50 -left-10 md:-left-60 lg:-left-80 pointer-events-none select-none">
            <div className="w-75 h-75 md:w-[550px] md:h-[550px] lg:w-[800px] lg:h-[800px] rounded-full blur-[100px] md:blur-[140px] bg-[radial-gradient(circle,#209181_0%,transparent_70%)]" />
          </div>
        </div>
      </div>
    </footer>
