          ...
          <div className="grid grid-cols-12 lg:gap-10">
                ...
                >
                  <div className="mb-10 flex">
                    <p className="text-secondary-content/70 leading-7 w-full">
                      ...
                      with Next.js, React, Node.js, Laravel, and MongoDB.
                      Focused on clean code, performance, and creating
            ...
            <div className="col-span-12 lg:col-span-5">
              <div className="h-full w-full flex items-center justify-center">
                <Reveal
                  initial="opacity-0 translate-y-10 scale-[0.92]"
                  view="opacity-100 translate-y-0 scale-100"
