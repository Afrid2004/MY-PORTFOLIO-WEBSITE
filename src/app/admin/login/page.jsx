  ...
  return (
    <main className="flex min-h-screen items-center justify-center px-4">
      <div className="w-full max-w-[400px]">
        ...
        {/* Card */}
        <div className="rounded-2xl border border-white/5 bg-base-200 p-6 transition-all duration-500 hover:border-white/15 sm:p-7">
          <form onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  autoComplete="email"
                  required
                  className="h-12 w-full rounded-xl border border-white/5 bg-base-100 pl-11 pr-4 text-sm outline-none transition-all duration-300 placeholder:text-base-content/50 focus:border-primary/30 focus:ring-1 focus:ring-primary/10"
                />
              </div>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="group cursor-pointer flex h-12 w-full items-center justify-center gap-2 rounded-xl bg-primary px-5 text-sm font-medium text-primary-content transition-all duration-300 hover:opacity-90 active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-60"
            >
              {loading ? (
                <>
                  <Spin />
