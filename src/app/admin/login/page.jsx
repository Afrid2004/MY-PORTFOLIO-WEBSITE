            ...
            <div className="mt-5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="h-12 w-full rounded-xl border border-white/10 bg-base-200 pl-11 pr-12 text-sm outline-none transition-all duration-300 placeholder:text-base-content/40 focus:border-primary/40 focus:ring-1 focus:ring-primary/10"
                />
                ...
                <button
                  ...
                  className="absolute right-4 top-1/2 -translate-y-1/2 cursor-pointer text-base-content/50 transition-colors hover:text-primary"
